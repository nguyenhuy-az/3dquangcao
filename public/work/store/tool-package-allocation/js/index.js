 ...
 */
var qc_work_store_tool_package_allocation = {
...
$(document).ready(function () {
    $('.qc_work_store_allocation_check_info').on('click', '.qc_view_image_get', function () {
        qc_work_store_tool_package_allocation.viewImage($(this).data('href'));
    });
});
...
$(document).ready(function () {
    ...
    $('.qc_work_store_allocation_check_info').on('click', '.qc_minus_money_get', function () {
        qc_work_store_tool_package_allocation.minusMoney.getForm($(this).data('href'));
    });
    //xac nhan
    $('body').on('click', '#frmWorkStoreAllocationMinusMoney .qc_save', function () {
        qc_work_store_tool_package_allocation.minusMoney.save($(this).parents('#frmWorkStoreAllocationMinusMoney'));
    });
});