    ...
    <div class="qc-padding-bot-30 col-sx-12 col-sm-12 col-md-12 col-lg-12">
        <div class="row">
            <div class="text-center col-sx-12 col-sm-12 col-md-12 col-lg-12" style="border-bottom: 2px dashed brown;">
                <h3 style="color: red;">THÔNG BÁO SỬA CHỬA SẢN PHẨM</h3>
            </div>
            <div class="qc-padding-top-20 col-sx-12 col-sm-12 col-md-12 col-lg-12">
                <form class="qc_frm_product_repair_add form-horizontal" name="qc_frm_product_repair_add" role="form"
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="form-group form-group-sm">
                                <label class="col-sm-3 control-label">Ảnh thông báo:</label>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="form-group form-group-sm">
                                <label class="col-sm-3 control-label">
                                    Ghi chú:<em style="color: red;">*</em>
                                </label>
                                <div class="col-sm-9">
                                    <input class="txtNote form-control" name="txtNote" value=""/>
                                </div>
                            </div>
                        </div>
                    </div>
