    ...
    <div class="qc-padding-bot-30 col-sx-12 col-sm-12 col-md-12 col-lg-12">
        <div class="row">
            <div class="text-center col-sx-12 col-sm-12 col-md-12 col-lg-12" style="border-bottom: 2px dashed brown;">
                <h3>THÊM THIẾT KẾ TỔNG THỂ</h3>
            </div>
            <div class="qc-padding-top-20 col-sx-12 col-sm-12 col-md-12 col-lg-12">
                <form class="qc_frm_order_add_design form-horizontal" name="qc_frm_order_add_design" role="form"
                      method="post" enctype="multipart/form-data"
                      action="{!! route('qc.work.orders.info.design.add.post',$dataOrder->orderId()) !!}">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="form-group form-group-sm">
                                <label class="col-sm-3 control-label">Đơn Hàng:</label>
                                <div class="col-sm-9">
                                    <span style="color: brown;">{!! $dataOrder->name()  !!}</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="form-group form-group-sm">
                                <label class="col-sm-3 control-label">Thiết kế tổng thể:</label>
                                <div class="col-sm-9">
