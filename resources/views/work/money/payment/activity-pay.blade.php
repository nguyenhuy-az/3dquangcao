                ...
                <table class="table table-hover table-bordered">
                    ...
                    @if($hFunction->checkCount($dataPayActivityDetail))
                        ...
                        @foreach($dataPayActivityDetail as $payActivityDetail)
                            <?php
                            $cancelId = $payActivityDetail->payId();
                            ...
                            <tr class="@if($n_o%2) info @endif">
                                ...
                                <td>
                                    {!! date('d/m/Y',strtotime($payActivityDetail->payDate()))  !!}
                                </td>
                                <td>
                                    <span>{!! $payActivityDetail->payActivityList->name() !!}</span>
                                </td>
                                <td>
                                    <span>{!! $payActivityDetail->note() !!}</span>
                                </td>
                                <td class="text-right">
