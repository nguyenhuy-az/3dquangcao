    ...
    <div class="qc-padding-bot-30 col-sx-12 col-sm-12 col-md-12 col-lg-12">
        <div class="row">
            <div class="text-center col-sx-12 col-sm-12 col-md-12 col-lg-12" style="border-bottom: 2px dashed brown;">
                ...
                <em class="qc-color-red">(Yêu cầu ướng lương phải được duyệt trước khi ứng)</em>
            </div>
            @if($dayCurrent > 15)
                <div class="text-center qc-padding-top-20 col-sx-12 col-sm-12 col-md-12 col-lg-12">
                    <p style="color: red; font-size: 20px;">
                        CHỈ ĐƯỢC YÊU CẦU ỨNG TRƯỚC NGÀY 15
                    </p>
            ...
            @else
                <div class="qc-padding-top-20 col-sx-12 col-sm-12 col-md-12 col-lg-12">
                    <form class="frm_work_before_pay_request form-horizontal" name="frm_work_before_pay_request"
                          role="form"
                          method="post"
