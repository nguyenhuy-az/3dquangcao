        ...
        <div class="col-sx-12 col-sm-12 col-md-12 col-lg-12">
            ...
            <div class="row">
                <div class="qc-padding-top-10 col-sx-12 col-sm-12 col-md-12 col-lg-12"
                    ...
                    <b style="color: brown;">Phân công</b>
                </div>
            </div>
            ...
            @else
                ...
                @else
                    <form id="frmAd3dAdd" role="form" method="post" enctype="multipart/form-data"
                          action="{!! route('qc.ad3d.order.product.work-allocation.add.post', $dataProduct->productId()) !!}">
                        <div class="row">
                        ...
                        <div class=" col-sx-12 col-sm-12 col-md-12 col-lg-12">
                            <div id="qc_product_work_allocation_staff_wrap" class="row">
                                ...
                                @else
                                    ...
                                    @include('ad3d.order.product.work-allocation-staff', compact('dataReceiveStaff','dataProduct'))
                                @endif
                        ...
                        <div class="row">
                            <div class="qc-padding-top-20 qc-padding-bot-20  qc-border-none text-left col-sx-12 col-sm-12 col-md-12 col-lg-12">
                                <a class="qc_product_work_allocation_staff_add qc-link-green"
                                   data-href="{!! route('qc.ad3d.order.product.work-allocation.staff.get',$dataProduct->productId()) !!}">
