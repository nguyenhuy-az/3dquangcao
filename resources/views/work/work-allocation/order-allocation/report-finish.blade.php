    ...
    <div class="qc-padding-bot-30 col-sx-12 col-sm-12 col-md-12 col-lg-12">
        <div class="row">
            <div class="text-center col-sx-12 col-sm-12 col-md-12 col-lg-12" style="border-bottom: 2px dashed brown;">
                <h3 style="color: red;">XÁC NHẬN HOÀN THÀNH </h3>
                <label style="color: blue;">Thời gian báo hoàn thành là giờ hiện tại</label>
            </div>
        </div>
        <div class="row">
            <div class="qc-padding-top-10 col-sx-12 col-sm-12 col-md-12 col-lg-12">
                <form class="frmWorkAllocationConstructionConfirm" role="form" method="post"
                      action="{!! route('qc.work.work_allocation.order_allocation.report_finish.post', $dataOrderAllocation->allocationId()) !!}">
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="text-center qc-padding-top-20 qc-padding-bot-20  qc-border-none col-sx-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <button type="button" class="qc_save btn btn-sm btn-primary">XÁC NHẬN BÁO CÁO</button>
