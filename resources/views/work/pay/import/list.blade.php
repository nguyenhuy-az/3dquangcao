                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            <tr>
                                ...
                                <td style="padding: 0 !important;">
                                    <select class="qc_work_pay_import_day_filter" style="height: 30px;" data-href="{!! $hrefIndex !!}">
                                    ...
                                    <select class="qc_work_pay_import_month_filter" style="height: 30px;" data-href="{!! $hrefIndex !!}">
                                    ...
                                    <select class="qc_work_pay_import_year_filter" style="height: 30px;" data-href="{!! $hrefIndex !!}">
                                ...
                                <td class="text-center" style="padding: 0;">
                                    <select class="qc_work_pay_import_pay_status form-control"
                                            data-href="{!! $hrefIndex !!}"
                                            style="border: 0;">
                                        ...
                                        <td class="text-center">
                                            @if($import->checkExactlyStatus())
                                                @if($import->checkPay())
                                                    ...
                                                    @else
                                                        <a class="qc_work_import_confirm_pay_act qc-link" style="background-color: red; padding: 3px; color: yellow !important;"
