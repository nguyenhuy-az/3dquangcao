            ...
            @if($dataLoginStaff->checkTreasureDepartment())
                <li @if($viewLoginObject == 'payActivity') class="active" @endif>
                    <a href="{!! route('qc.work.pay.pay_activity.get') !!}"
                       @if($viewLoginObject == 'payActivity') style="background-color: whitesmoke;" @endif>
                        Chi hoạt động
                    </a>
                </li>
                <li @if($viewLoginObject == 'payImport') class="active" @endif>
                    <a href="{!! route('qc.work.pay.import.get') !!}"
                       @if($viewLoginObject == 'payImport') style="background-color: whitesmoke;" @endif>
                        Thanh toán mua vật tu
                    </a>
                </li>
                <li @if($viewLoginObject == 'paySalaryBeforePay') class="active" @endif>
                    <a href="{!! route('qc.work.pay.salary_before_pay.get') !!}"
                       @if($viewLoginObject == 'paySalaryBeforePay') style="background-color: whitesmoke;" @endif >
                        Ứng lương mua vật tư
                    </a>
                </li>
                <li @if($viewLoginObject == 'paySalary') class="active" @endif>
                    <a href="{!! route('qc.work.pay.pay_salary.get') !!}"
                       @if($viewLoginObject == 'paySalary') style="background-color: whitesmoke" @endif>
                        Thanh toán lương
                    </a>
                </li>
                <li @if($viewLoginObject == 'payKeepMoney') class="active" @endif>
                    <a href="{!! route('qc.work.pay.keep_money.get') !!}"
                       @if($viewLoginObject == 'payKeepMoney') style="background-color: whitesmoke;" @endif>
                        Thanh toán tiền giữ
                    </a>
                </li>
            @endif
