...
@section('qc_master_body')
    <div class="row">
        <div class="col-xs-12 col-sm-1 col-md-12 col-lg-12">
            <form class="frmWorRecruitmentRegister" role="form" name="frmWorRecruitmentRegister" method="post" action="{!! route('qc.work.recruitment.login.post') !!}">
                <div class="row">
                    <div class="qc-padding-top-20 col-xs-12 col-sm-12 col-md-6 col-md-offset-3 col-lg-6 col-lg-offset-3">
                        <div class="form-group form-group-sm qc-padding-none">
                            ...
                            <input type="text" class="form-control" name="txtPhoneNumber" placeholder="Nhận số điện thoại" value="">
                        </div>
