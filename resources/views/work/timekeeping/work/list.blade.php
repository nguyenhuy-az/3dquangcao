                                        ...
                                        <table class="table table-hover qc-margin-bot-none">
                                            ...
                                            @if($infoSalaryBasic)
                                                ...
                                                <tr style="border-top: 1px solid whitesmoke; color: brown;">
                                                    ...
                                                    <td class="text-right">
                                                        <b class="qc-color-red">{!! $hFunction->currencyFormat($totalCurrentSalary + $totalMoneyOvertimeHour + $totalMoneyBonus -  $totalMoneyBeforePay - $totalMoneyMinus) !!}</b>
                                                    </td>
                                                </tr>
                                            @else
                                                <tr>
                                    ...
                                    @if($hFunction->checkCount($dataTimekeeping))
                                        ...
                                        @foreach($dataTimekeeping as $timekeeping)
                                            ...
                                            <tr class="@if($n_o%2) info @endif">
                                                ...
                                                <td>
                                                    @if(!$hFunction->checkEmpty($timekeepingConfirmNote))
                                                        DUYỆT:
                                                    ...
                                                    @if(!$hFunction->checkEmpty($timekeepingNote))
                                                        <br/>
                                                        BÁO GIỜ: <em
                                                                class="qc-color-grey"> {!! $timekeepingNote !!}</em>
                                                    @endif
