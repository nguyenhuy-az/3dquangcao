...
$dataTimekeepingProvisionalWarning = $dataTimekeepingProvisional->timekeepingProvisionalWarningGetTimeEnd();
?>
    ...
    <div class="qc-padding-bot-30 col-sx-12 col-sm-12 col-md-12 col-lg-12">
        <div class="row">
            <div class="text-center col-sx-12 col-sm-12 col-md-12 col-lg-12">
                <h3 style="color: red;">CẢNH BÁO GIỜ RA KHÔNG ĐÚNG</h3>
            </div>
            ...
            @else
                <div class="col-sx-12 col-sm-12 col-md-12 col-lg-12">
                    <form class="qc_frm_warming_time_end_add form" name="qc_frm_warming_time_end_add" role="form"
                          method="post"
                          enctype="multipart/form-data"
                          action="{!! route('qc.ad3d.work.time_keeping_provisional.warning_end.post',$timekeepingId) !!}">
                        <div class="row">
