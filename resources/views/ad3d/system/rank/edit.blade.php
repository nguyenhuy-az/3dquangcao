    ...
    <div class="qc-padding-bot-30 col-sx-12 col-sm-12 col-md-12 col-lg-12">
        <div class="row">
            ...
            <div class="qc-padding-top-20 col-sx-12 col-sm-12 col-md-12 col-lg-12">
                <form class="frmEdit" name="frmEdit" role="form" method="post" action="{!! route('qc.ad3d.system.rank.post.get', $dataRank->rankId()) !!}">
                            ...
                            <div class="col-sx-12 col-sm-12 col-md-12 col-lg-12"
                                ...
                                <div class="form-group form-group-sm">
                                    ...
                                    <input type="text" name="txtDescription" class="form-control"
                                           placeholder="Nhập mô tả" value="{!! $dataRank->description() !!}">
                                </div>
                            </div>
                        </div>
                    </div>
