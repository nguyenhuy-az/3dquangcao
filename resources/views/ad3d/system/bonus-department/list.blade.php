        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"
            ...
            <div class="row">
                <div class="text-left col-xs-12 col-sm-12 col-md-12 col-lg-12"
                    ...
                    &nbsp;
                    <label class="qc-font-size-20" style="color: red;">THƯỞNG/PHẠT THEO BỘ PHẬN</label>
                </div>
            </div>
            <div class="row">
            ...
            <div class="qc_ad3d_list_content row">
                <table class="table table-hover table-bordered">
                    ...
                    @if($hFunction->checkCount($dataDepartment))
                        ...
                        @endforeach
                        <tr>
                            <td class="text-right" colspan="3" style="color: red">
