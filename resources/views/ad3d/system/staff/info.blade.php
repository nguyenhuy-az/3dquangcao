                                        ...
                                        <div class="text-center col-xs-12 col-sm-12 col-md-12 col-lg-12"
                                            ...
                                            <div style="position: relative; margin: 5px 10px 5px 10px; width: 100%; height: 100%;">
                                                <a class="qc-link" data-href="#">
                                                    <img style="max-width: 100%;height: 110px; border: 1px solid #d7d7d7;"
                                                         src="{!! $imageSrc !!}">
                                                </a>
                                                @if(!$hFunction->checkEmpty($image))
                                    ...
                                    <div class="row">
                                        <div class="text-center col-xs-6 col-sm-6 col-md-6 col-lg-6"
                                            ...
                                            <div style="position: relative; width: 100%; height: 100%;">
                                                <a class="qc-link" data-href="#">
                                                    <img style="max-width: 100%;height: 70px;border: 1px solid #d7d7d7;"
            ...
            <div class="row">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="text-right">
                                                                        @if($hFunction->checkCount($dataWorkSkill))
                                                                            <em style="color: grey;">
                                                                                - {!! $dataWorkSkill->levelLabel($dataWorkSkill->level()) !!}
                                                                            </em>
                                                                        @else
                                                                            <em style="color: grey;">
                                                                                - Không biết
                ...
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6" @if($mobileStatus) style="padding: 0;" @endif>
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="glyphicon glyphicon-record" style="font-size: 1.5em;"></i>
                            <label style="font-size: 1.5em; color: red;">LƯƠNG CƠ BẢN</label>
                            @if($actionStatus)
