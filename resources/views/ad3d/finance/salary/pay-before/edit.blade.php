        ...
        <div class="row">
            ...
            <div class="col-sx-12 col-sm-12 col-md-12 col-lg-12">
                <form class="frmEdit" name="frmEdit" role="form" method="post"
                      action="{!! route('qc.ad3d.finance.salary.pay-before.edit.post',$dataSalaryBeforePay->payId()) !!}">
                    <div class="col-sx-12 col-sm-12 col-md-12 col-lg-12"
                            ...
                            <div class="form-group">
                                <select name="cbDay" style="margin-top: 5px; height: 30px;">
                                    @for($i = $hFunction->getDayFromDate($fromDate);$i<= 31; $i++)
                                        <option value="{!! $i !!}" @if($hFunction->getDayFromDate($dataSalaryBeforePay->datePay()) == $i) selected="selected" @endif >{!! $i !!}</option>
                                    @endfor
                                </select>
                                /
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"
                             @if($mobileStatus) style="padding: 0 0;" @endif>
                            <div class="form-group qc-padding-none">
                                <label>Tổng tiền đã ứng(VND):</label>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"
                            ...
                            <div class="form-group qc-padding-none">
                                ...
                                <input type="number" class="form-control" name="txtMoney" placeholder="Nhập số tiền"
                                       value="{!! $dataSalaryBeforePay->money() !!}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"
                            ...
                            <div class="form-group qc-padding-none">
                                ...
                                <input type="text" class="form-control" name="txtDescription"
                                       value="{!! $dataSalaryBeforePay->description() !!}">
                            </div>
                        </div>
                    </div>
                    <div class="text-center col-sx-12 col-sm-12 col-md-12 col-lg-12">
