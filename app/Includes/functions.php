...
class Hfunction
{
    ...
    {
        $string = $this->convert_vi_to_en($string);# chuyen sang chu khong dau
        $newString = '';
    ...
    # chuyen toa chuoi sang chu hoa
    public function mp_strtoupper($str)
    {
        return mb_convert_case($str, MB_CASE_UPPER, "UTF-8");;//mb_strtoupper($str, 'UTF-8');//mb_strtoupper($str);
    }
