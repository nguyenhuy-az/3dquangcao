...
class OrdersController extends Controller
{
    ...
    public function postEditAddProduct($orderId)
    {
        ...
        $pageBack = 2;
        return view('work.orders.orders.order-info', compact('dataAccess', 'dataOrders', 'pageBack'));
    }
    ...
    public function getProductConfirm($productId = null)
    {
        ...
        if (count($dataProduct) > 0) {
            return view('work.orders.product.confirm-finish', compact('dataProduct'));
        }
    }
    ...
    #huy san pham
    public function cancelProductConfirm($productId = null)
    {
        $modelProduct = new QcProduct();
        $dataProduct = $modelProduct->getInfo($productId);
        if (count($dataProduct) > 0) {
            $modelProduct->cancelProduct($productId);
        }
    }
