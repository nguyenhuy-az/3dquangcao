...
class QcProduct extends Model
{
    ...
    public function cancelProduct($productId = null)
    {
        $modelStaff = new QcStaff();
        $staffLoginId = $modelStaff->loginStaffId();
        return QcProduct::where('product_id', $this->checkIdNull($productId))->update(['finishStatus' => 1, 'cancelStatus' => 1, 'confirmStaff_id' => $staffLoginId]);
    }
