...
class QcOrder extends Model
{
    ...
    protected $fillable = ['order_id', 'nameCode', 'name', 'constructionAddress', 'constructionPhone', 'constructionContact',
        ...
        'staffConfirm_id', 'staffKpi_id', 'created_at', 'provisionalStatus', 'provisionalDate', 'provisionalConfirm'];
    ...
    # xac nhan hoan thanh
    public function updateFinish($orderId, $finishStatus, $staffConfirmId)
    {
        return QcOrder::where('order_id', $orderId)->update([
