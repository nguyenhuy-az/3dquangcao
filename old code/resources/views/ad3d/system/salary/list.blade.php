                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-bordered">
                                <tr style="background-color: whitesmoke;">
                                    ...
                                    <th class="text-center qc-padding-none">Từ ngày</th>
                                    <th class="text-center qc-padding-none">Đến ngày</th>
                                ...
                                @foreach($dataStaffSalaryBasic as $salaryBasic)
                                    ...
                                    ?>
                                    <tr class="qc_ad3d_list_object qc-ad3d-list-object row" data-object="{!! $salaryBasicId !!}">
