...
@section('qc_ad3d_index_content')
    <div class="row">
        ...
        <div class="qc-padding-top-20 col-sx-12 col-sm-12 col-md-12 col-lg-8">
            <form class="frmAdd" name="frmAdd" role="form" method="post" action="{!! route('qc.ad3d.system.punish-type.add.post') !!}">
                <div class="row">
                ...
                <div class="row">
                    <div class="col-sx-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="form-group form-group-sm">
                            ...
                            <a href="{!! route('qc.ad3d.system.punish-type.get') !!}">
