                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-bordered">
                                ...
                                <tr style="border-top: 2px solid brown;" >
                                    ...
                                    <td class="text-right qc-color-red">
                                        {!! $hFunction->currencyFormat($totalMoneyImport + $totalMoneyTransfer + $totalMoneyPaidSalaryBeforePay + $totalMoneyPaidSalaryPay)  !!}
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-right qc-color-green" colspan="2" >
                                        {!! $hFunction->currencyFormat($totalMoneyOrderPay + $totalMoneyImportPaidOfStaff + $totalReceivedMoneyOfStaffAndDate - ($totalMoneyImport + $totalMoneyTransfer + $totalMoneyPaidSalaryBeforePay + $totalMoneyPaidSalaryPay) )  !!}
                                    </td>
                                </tr>
                            </table>
                        </div>
