...
@section('qc_ad3d_container_wrap')
    <div id="qc_container_content"
         class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 qc-position-abs qc-zindex-2 qc-margin-top-40 qc-border-radius-10 qc-padding-none qc-bg-white qc-overflow-auto ">
        {{--contain action form--}}
