    ...
    <div class="row">
        <div class="col-sx-12 col-sm-12 col-md-12 col-lg-12"
            ...
            <div class="row">
                <div class="text-left col-xs-12 col-sm-12 col-md-6 col-lg-6" style="padding-left: 0;padding-right: 0;">
                    <a class="qc-link-green-bold" href="{!! route('qc.ad3d.work.work.old.get') !!}">
                ...
                <div class="text-right col-xs-12 col-sm-12 col-md-6 col-lg-6" style="padding-left: 0;padding-right: 0;">
                    <select class="cbCompanyFilter" name="cbCompanyFilter" style="margin-top: 5px; height: 25px;"
                            data-href-filter="{!! route('qc.ad3d.work.work.old.get') !!}">
        ...
        <div class="col-sx-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="row">
                                    ...
                                    <input type="text" class="textFilterName form-control" name="textFilterName"
                                      ...
                                      <span class="input-group-btn">
                                            <button class="btFilterName btn btn-default" type="button"
                                                    style="height: 25px;"
                                                    data-href="{!! route('qc.ad3d.work.work.old.get') !!}">Tìm
                                            </button>
                                      </span>
                                </div>
                            </div>
                            <div class="text-right col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                <select class="cbMonthFilter" style="margin-top: 5px; height: 25px;"
                                        data-href="{!! route('qc.ad3d.work.work.old.get') !!}">
            ...
            <div class="qc_ad3d_list_content row"
                 data-href-view="{!! route('qc.ad3d.work.work.view_old.get') !!}"
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-bordered">
                            <tr style="background-color: whitesmoke;">
                                ...
                                <th class="text-center qc-padding-none">Tháng</th>
                            ...
                            @foreach($dataWork as $work)
                                ...
                                <tr class="qc_ad3d_list_object" data-object="{!! $workId !!}">
                                    ...
                                    <td class="text-center qc-padding-none">
                                        {!! $hFunction->getMonthFromDate($work->fromDate()) !!}
                                    </td>
                                    <td class="text-center qc-padding-none">
