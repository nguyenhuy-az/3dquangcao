...
$licenseId = $dataLicenseOffWork->licenseId();
$dateOff = $dataLicenseOffWork->dateOff();
$note = $dataLicenseOffWork->note();
...
@section('qc_ad3d_container_content')
    ...
    <div class="qc-padding-top-10 col-sx-12 col-sm-12 col-md-12 col-lg-12">
        <form class="qc_ad3d_frm_confirm form-horizontal" name="qc_ad3d_frm_confirm" role="form" method="post"
              action="{!! route('qc.ad3d.work.off-work.confirm.post') !!}">
            <div class="row">
                    ...
                    <div class="form-group form-group-sm">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="text" readonly="true"
                                   value="{!! $dataLicenseOffWork->staff->fullName() !!}"/>
                        </div>
                    </div>
                </div>
            </div>
