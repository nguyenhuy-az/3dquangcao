    ...
    <div id="qc_work_orders_wrap" class="row qc_work_orders_wrap">
        <div class="qc-padding-bot-20 col-sx-12 col-sm-12 col-md-12 col-lg-12">
            ...
            <div class="qc-padding-top-5 qc-padding-bot-5 col-sx-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <div class="qc_work_orders_list_content row" style="min-height: 3000px;"
                                                ...
                                                <div id="order_menu_{!! $orderId !!}" class="row qc-display-none">
                                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                        @if($checkOrderOfReceiveStaff)
                                                            ...
                                                            &nbsp;&nbsp;
                                                        @endif
                                                        <a class="qc-link-green" title="Xem chi tiết"
                                            ...
                                            <td>
                                                ...
                                                <a class="qc-link-red"
                                                   href="{!! route('qc.work.orders.add.get',"1/$customerId/$orderId") !!}">
                                                    <i class="glyphicon glyphicon-shopping-cart" title="Đặt hàng"></i>
                                                </a>
                                                <span>|</span>
                                                <a class="qc-link"
                                                   href="{!! route('qc.work.orders.add.get',"0/$customerId/$orderId") !!}">
                                                    <i class="glyphicon glyphicon-list-alt" title="Báo giá"></i>
                                                </a>
                                            </td>
                                            <td class="text-center">
