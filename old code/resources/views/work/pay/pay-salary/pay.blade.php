...
$totalMoneyAllPay = $totalSalaryUnpaid + $totalMoneyImportUnpaid + $totalKPIMoney;
?>
@extends('work.index')
@section('titlePage')
    Thanh toán lương
                ...
                <form id="frm_work_pay_salary_pay" role="form" method="post"
                    ...
                    <div class="row">
                        ...
                        <div class="text-right col-sx-12 col-sm-12 col-md-6 col-lg-6">
                            <em>Từ: </em><span class="qc-color-red qc-font-bold">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-bordered">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-group form-group-sm">
                                        <label>Tiền cộng thêm (Thưởng...)</label>
                                ...
                                <td class="text-right">
                                    {{--<b class="showBenefitMoney"> {!! $hFunction->currencyFormat(0) !!}</b>--}}
                                </td>
                            </tr>
