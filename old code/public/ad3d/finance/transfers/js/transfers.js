...
$(document).ready(function () {
    $('.qc_ad3d_list_object').on('click', '.qc_view', function () {
        qc_ad3d_finance_transfers.view($(this).parents('.qc_ad3d_list_object'));
    })
});
...
$(document).ready(function () {
    ...
    $('.qc_ad3d_index_content').on('click', '.frmAdd .qc_save', function () {
        qc_ad3d_finance_transfers.add.save($(this).parents('.frmAdd'));
    })
});
...
$(document).ready(function () {
    $('.qc_ad3d_list_object').on('click', '.qc_edit', function () {
        qc_ad3d_finance_transfers.edit.get($(this).parents('.qc_ad3d_list_object'));
    });

    $('body').on('click', '.frmEdit .qc_save', function () {
        qc_ad3d_finance_transfers.edit.save($(this).parents('.frmEdit'));
    });
});
...
$(document).ready(function () {
    $('.qc_ad3d_list_object').on('click', '.qc_ad3d_transfer_confirm_receive_act', function () {
        qc_ad3d_finance_transfers.confirm.get($(this).data('href'));
    });

    $('body').on('click', '.frmAd3dTransferConfirmReceive .qc_save', function () {
        qc_ad3d_finance_transfers.confirm.save($(this).parents('.frmAd3dTransferConfirmReceive'));
    });
});
...
$(document).ready(function () {
    $('.qc_ad3d_list_object').on('click', '.qc_delete', function () {
        qc_ad3d_finance_transfers.delete($(this).parents('.qc_ad3d_list_object'));
    });
});
