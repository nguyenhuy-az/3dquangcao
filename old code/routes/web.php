...
Route::group(['prefix' => 'work'], function () {
    ...
    Route::group(['prefix' => 'orders'], function () {
        ...
        Route::group(['prefix' => 'product'], function () {
            ...
            # huy don hang
            Route::get('cancel/{productId?}', ['as' => 'qc.work.orders.product.cancel.get', 'uses' => 'Work\Orders\OrdersController@cancelProductConfirm']);
        ...
        // huy don hang
        Route::get('delete/{orderId?}', ['as' => 'qc.work.orders.delete.get', 'uses' => 'Work\Orders\OrdersController@cancelOrders']);
    ...
    Route::group(['prefix' => 'salary'], function () {
        ...
        Route::group(['prefix' => 'before-pay'], function () {
            Route::get('request/{workId?}', ['as' => 'qc.work.salary.before_pay.request.get', 'uses' => 'Work\Salary\BeforePay\SalaryBeforePayController@getBeforePayRequest']);
    ...
    # cho ung luong mua vat tu
    Route::group(['prefix' => 'pay-salary-before-pay'], function () {
        Route::get('add/{salaryId?}', ['as' => 'qc.work.pay.pay_salary_before_pay.add.get', 'uses' => 'Work\Pay\PaySalaryBeforePay\PaySalaryBeforePayController@getAdd']);
        Route::post('add/{salaryId?}', ['as' => 'qc.work.pay.pay_salary_before_pay.add.post', 'uses' => 'Work\Pay\PaySalaryBeforePay\PaySalaryBeforePayController@postAdd']);
        Route::get('/{loginMonth?}/{loginYear?}/{payStatus?}', ['as' => 'qc.work.pay.pay_salary_before_pay.get', 'uses' => 'Work\Pay\PaySalaryBeforePay\PaySalaryBeforePayController@index']);
    });
